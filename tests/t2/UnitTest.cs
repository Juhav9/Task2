...
public class UnitTest : AppTestBase
{
    ...
    [Fact]
    public void Checkpoint02_Shape1_NameAndContent()
    {
    ...
    [Fact]
    public void Checkpoint02_Shape1_Methods()
    {
    ...
    [Fact]
    public void Checkpoint02_Shape1_DefaultValue()
    {
    ...
    public void Checkpoint02_Shape1_Values(Tuple<double, double> data, Tuple<double, double> expected)
    {
