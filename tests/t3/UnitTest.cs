...
public class UnitTest : AppTestBase
{
    ...
    [Fact]
    public void Checkpoint03_Shape2_NameAndContent()
    {
    ...
    [Fact]
    public void Checkpoint03_Shape2_Methods()
    {
    ...
    [Fact]
    public void Checkpoint03_Shape2_DefaultValue()
    {
    ...
    public void Checkpoint03_Shape2_Values(double data, Tuple<double, double> expected)
    {
